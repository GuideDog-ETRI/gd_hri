...
# Project ERP image to Rectilinear image
...
# @ret rect_image: rectilinear projection image (resolution determined automatically relative to input ERP image)
