...
rosidl_generate_interfaces(${PROJECT_NAME}
  ...
  "srv/GdqSrv1.srv"
  "srv/GdqSrv2.srv"
  DEPENDENCIES geometry_msgs std_msgs sensor_msgs nav_msgs grid_map_msgs # Add packages that above messages depend on, in this case geometry_msgs for Sphere.msg
)
